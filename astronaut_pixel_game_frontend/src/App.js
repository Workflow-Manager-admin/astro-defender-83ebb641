...
/**
 * Constants - with task elements removed.
 */
...
/*
 * Main Game Component with Level Progression Mechanic (10 levels), without 'tasks' logic.
 */
// PUBLIC_INTERFACE
function AstronautPixelGame() {
  ...
  useEffect(() => {
    ...
    function loop() {
      ...
      const levelSettings = [
        null,
        { asteroidCooldown: 120, asteroidMinV: 0.5, asteroidMaxV: 0.85, asteroidSize: [16, 22], aliensAllowed: false, alienCooldown: Infinity },
        { asteroidCooldown: 90,  asteroidMinV: 0.75, asteroidMaxV: 1.1, asteroidSize: [15, 23], aliensAllowed: true, alienCooldown: 180 },
        { asteroidCooldown: 70,  asteroidMinV: 0.95, asteroidMaxV: 1.28, asteroidSize: [15, 23], aliensAllowed: true, alienCooldown: 140 },
        { asteroidCooldown: 60,  asteroidMinV: 1.1, asteroidMaxV: 1.35, asteroidSize: [14, 24], aliensAllowed: true, alienCooldown: 120 },
        ...
        { asteroidCooldown: 22,  asteroidMinV: 1.65, asteroidMaxV: 2.22, asteroidSize: [12, 19], aliensAllowed: true, alienCooldown: 41 },
      ];
      ...
      if (stats.time - lastAsteroid > ls.asteroidCooldown) {
        ...
        const randVy = (Math.random() - 0.5) * 0.93;
    ...
    // eslint-disable-next-line
  }, [running, paused, gameOver, stats.time, level]);
...
/**
 * PUBLIC_INTERFACE
 * Main App entry point. The subtitle and UI has been revised to remove references to tasks.
 */
function App() {
  return (
    <div className="App pixel" style={{ background: "#162124", minHeight: "100vh" }}>
      <header>
        ...
        <span className="subtitle">
          A pixel-style 2D side-scroller. Survive, defend your ship, and reach the highest level!
        </span>
      </header>
      <AstronautPixelGame />
